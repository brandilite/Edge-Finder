  ...
  return (
    <div className="p-5 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="bg-[#111111] border border-[#1a1a1a] rounded-lg px-3 py-2 text-sm text-white"
          >
            {SYMBOLS.map((s) => (
          ...
          <button
            onClick={clearChat}
            className="px-3 py-2 text-sm bg-[#111111] text-gray-400 hover:text-white rounded-lg border border-[#1a1a1a] transition-colors"
          >
            Clear
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        {/* Chat */}
        <div className="flex flex-col bg-[#0a0a0a] rounded-lg border border-[#1a1a1a] overflow-hidden" style={{ height: 'calc(100vh - 160px)' }}>
